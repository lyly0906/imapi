...
public class CompanyVO {
	...
	private @Indexed String outRelaId; //外部关联id
	
	
	private @Indexed int type = 0; //类型值      5:默认加入的公司
	
	private @NotSaved List<DepartmentVO> departments;  //公司的部门列表
	...
	public String getOutRealId() { return outRelaId; }
	public void setOutRealId(String outRelaId) { this.outRelaId = outRelaId; }
